...
export default function GymDashboardPage() {
  ...
  if (loading) {
    return (
      <PageLayout title="Dashboard Academia" backTo="more">
        <PageContainer title="Dashboard Academia" subtitle="Gestão completa dos seus alunos">
  ...
  return (
    <PageLayout title="Dashboard Academia" backTo="more">
      <PageContainer title="Dashboard Academia" subtitle="Gestão completa dos seus alunos" badge="B2B" maxWidth="full">
